...
### Тестирование UI
:link: В этой части дипломного проекта: <a target="_blank" href="https://github.com/Bigwatch86/thesis-project-UI">Проект по тестированию главной страницы интернет-магазина "Ситилинк".</a></br></br>
:heavy_check_mark: реализованы автотесты UI на проверку элементов главной страницы интернет-магазина "Ситиилнк", а также поиск товара в каталоге.</br></br>
